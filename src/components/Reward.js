...
localStorage.setItem("selected", imgData);
...
function Dragover(e){
    ...
    return (<>
     <button className="modal-btn" onClick={toggleModal}>GET REWARD</button>
          <Modal
         isOpen={modal}
...
<div className="nums"  onDrop={drop} onDragOver={e=>e.preventDefault()}> <p>pick 1 sticker</p>
  <img src={"data:image/png;base64," + localStorage.getItem('selected')}     alt=" " />
  <p></p>
{/* <span>1</span>
<span>2</span>
<span>3</span>
